...
export default function UnstitchedCottonPage() {
...
useEffect(() => {
  const fetchProducts = async () => {
    try {
      ...
      console.error("Failed to fetch unstitched cotton products", err);
    } finally {
      setLoading(false);
    }
  };
...
if (sort === "new") {
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-5 mb-20">
        <Breadcrumb category="Unstitched Cotton" />

        <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">
          Unstitched Cotton Wear
        </h1>
  ...
  <p className="text-center text-gray-500">
    Loading unstitched cotton products...
  </p>
)}

{!loading && filtered.length === 0 && (
  <p className="text-center text-gray-500">
    No unstitched cotton products found.
  </p>
)}
