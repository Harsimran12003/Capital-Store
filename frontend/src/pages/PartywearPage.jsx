...
useEffect(() => {
  const fetchPartywearProducts = async () => {
    try {
      ...
      console.error("Failed to fetch partywear products", err);
    } finally {
      setLoading(false);
    }
  };

  fetchPartywearProducts();
}, []);
...
if (sort === "below1000")
  ...
  <p className="text-center text-gray-500">
    Loading partywear products...
  </p>
)}

{!loading && filtered.length === 0 && (
  <p className="text-center text-gray-500">
    No partywear products found.
  </p>
)}
