  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#4D192B]">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md text-center">
        ...
        <p className="text-gray-500 mb-6">Secure admin access login</p>

        {err && (
          <p className="bg-red-100 text-red-600 py-2 rounded-lg mb-3">{err}</p>
        )}
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-lg bg-[#4D192B] text-white font-semibold tracking-wide hover:opacity-90 cursor-pointer"
          >
            Login
          </button>
        </form>
