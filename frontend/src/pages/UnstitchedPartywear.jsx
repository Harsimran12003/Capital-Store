...
const unstitchedpartywearProducts = [
  {
    id: 1,
...
export default function UnstitchedPartywearPage() {
  ...
  // FILTER LOGIC
  let filtered = unstitchedpartywearProducts.filter((p) => {
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-45 mb-20">
        <Breadcrumb category="Party Wear"/>

        <h1 className="text-3xl font-bold mb-8">Unstitched Party Wear</h1>
